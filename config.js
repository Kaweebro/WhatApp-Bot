...
module.exports = {
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'Stefanie' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? '' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/0edc0f3917fde20a7990a.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? '*Copyright © 2021 | Queen Stefanie*' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ˢᵗᵉᶠᵃⁿⁱᵉ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
